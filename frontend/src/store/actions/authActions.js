...
//delete lecturer profile Img
export const delLecturerProfileImg = () => async (dispatch) => {
	console.log('write the code to do this');
};

//TODO: delete student profile Img
export const delStudentProfileImg = () => {
	console.log('write the code to do this');
};
