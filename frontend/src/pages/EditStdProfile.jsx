...
import { changeUserPassword, setStudentProfileImg } from '../store/actions/authActions';
									...
									<form onSubmit={handleSubmit}>
										<div className="uk-width-1-1 uk-margin">
											...
											<input
												...
												className={`uk-input uk-form-large ${
													touched.oldPassword && errors.oldPassword ? 'uk-form-danger' : null
												}`}
												type="password"
										...
										<div className="uk-width-1-1 uk-margin">
											...
											<input
												...
												name="newPassword"
												className={`uk-input uk-form-large ${
													touched.newPassword && errors.newPassword ? 'uk-form-danger' : null
												}`}
												type="password"
										...
										<div className="uk-width-1-1 uk-margin">
											...
											/>
											{touched.confirmPassword && errors.confirmPassword ? (
												<p className="uk-text-danger">{errors.confirmPassword}</p>
											) : null}
										</div>
										<button
								...
								<form onSubmit={handleSubmit}>
									<div className="uk-width-1-1 uk-margin">
										...
										<input
											...
											name="phoneNo"
											className={`uk-input uk-form-large ${
												touched.phoneNo && errors.phoneNo ? 'uk-form-danger' : null
											}`}
											type="text"
...
export default connect(null, { changeUserPassword, setStudentProfileImg })(EditProfile);
